...
import com.example.petstoreservice.PlashScreen.Model.ProductMeal
...
// Tính tổng calo từ danh sách sản phẩm trong model
    val totalCalories = productMealModel.lunchList.sumOf { it.calor }
    ...
    val caloout by remember { mutableStateOf(400) }
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
        ...
        Column (
            ...
            if (productList.isEmpty()){
                ...
                Text(
                    ...
                    text = "${meal} составляет 50% калорий в день.\n Рекомендации по питанию: 350-400 Kcal.",
                    fontSize = 12.sp,
                    color = Color.Gray
                )
            } else{
                val progress = totalCalories.toFloat()/400f
                Row (
                    modifier = Modifier.fillMaxWidth().padding(10.dp,5.dp),
                    verticalAlignment = Alignment.CenterVertically,
                    horizontalArrangement = Arrangement.SpaceBetween
