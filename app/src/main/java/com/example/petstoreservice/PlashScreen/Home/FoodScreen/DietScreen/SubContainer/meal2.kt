...
fun mealdinner(
    ...
    val totalCalories = productMealModel.dinnerList.sumOf { it.calor }
    ...
    val caloout by remember { mutableStateOf(280) }
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
        ...
        Column (
            ...
            if (productList.isEmpty()){
                ...
                Text(
                    ...
                    text = "${meal} составляет  35% калорий в день.\n Рекомендации по питанию: 250-280 Kcal.",
                    fontSize = 12.sp,
                    color = Color.Gray
                )
            } else{
                val progress = totalCalories.toFloat()/280f
                Row (
                    modifier = Modifier.fillMaxWidth().padding(10.dp,5.dp),
                    verticalAlignment = Alignment.CenterVertically,
                    horizontalArrangement = Arrangement.SpaceBetween
